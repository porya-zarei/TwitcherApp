            ...
            <div className="flex justify-center content-start flex-wrap flex-row rounded-md shadow-sm -space-y-px">
                <div className="w-full flex items-center justify-between">
                    ...
                    <input
                        ...
                        type="text"
                        required
                        className="appearance-none rounded-none rounded-t-md relative block w-full px-3 py-2 border border-secondary placeholder-secondary text-dark focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
